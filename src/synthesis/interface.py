...
Defines core structures for pharmaceutical section continuation synthesis.
"""
...
class SectionProfile:
    ...
    Defines hard constraints for synthesis.
    """
...
class ContinuationConstraints:
    """
    Hard constraints for continuation synthesis.
...
class ContinuationResult:
    """
    Result of continuation synthesis for a gap.
    """
    gap_id: str
