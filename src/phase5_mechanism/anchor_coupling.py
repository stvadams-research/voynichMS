"""
Anchor-coupling phase2_analysis utilities for SK-H1 multimodal evidence hardening.
"""
...
def decide_status(
    *,
    ...
    if adequacy.get("blocked"):
        ...
        decision = phase4_inference.get("decision")
