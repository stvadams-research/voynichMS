...
class TopologySimulator:
    def __init__(self, grammar_path: Path, vocab_size: int = 3600, seed: int | None = None):
...
class GridTopologySimulator(TopologySimulator):
    """60x60 Grid"""
    def __init__(self, grammar_path: Path, rows: int = 60, cols: int = 60, seed: int | None = None):
...
class LayeredTableSimulator(TopologySimulator):
    ...
    def __init__(self, grammar_path: Path, layers: int = 10, size: int = 20, seed: int | None = None):
...
class DAGTopologySimulator(TopologySimulator):
    ...
    def __init__(self, grammar_path: Path, num_nodes: int = 4000, seed: int | None = None):
