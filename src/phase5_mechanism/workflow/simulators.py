...
class LineScopedPoolSimulator:
    ...
    """
    def __init__(self, grammar_path: Path, mean_pool_size: float = 10.0, seed: int | None = None):
...
class WeaklyCoupledPoolSimulator:
    ...
    """
    def __init__(self, grammar_path: Path, reservoir_size: int = 50, drift_rate: float = 0.1, seed: int | None = None):
