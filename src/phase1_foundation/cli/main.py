...
app.add_typer(analysis_app, name="phase2_analysis", help="Analysis and comparison commands")
...
app.add_typer(sensitivity_app, name="sensitivity", help="Sensitivity phase2_analysis commands")
...
def get_metadata_store():
    ...
    if not os.path.exists(db_file):
        ...
        console.print("[yellow]Hint:[/yellow] Run 'python scripts/phase1_foundation/acceptance_test.py' or similar initialization script.")
...
def run_sensitivity(
    ...
    """
    Run a sensitivity phase2_analysis sweep.
    """
...
def add_admissibility_constraint(
    ...
    with active_run(config={"command": "admissibility add-constraint", "class": class_id}) as run:
        ...
        from phase2_analysis.admissibility.manager import AdmissibilityManager, ConstraintType
...
def map_admissibility_evidence(
    ...
    with active_run(config={"command": "admissibility map-evidence", "class": class_id}) as run:
        ...
        from phase2_analysis.admissibility.manager import AdmissibilityManager, SupportLevel
...
def list_classes():
    ...
    from phase1_foundation.storage.metadata import ExplanationClassRecord
