...
class AnomalyDefinition:
    ...
    This is fixed for Phase 2.4 phase2_analysis. Contains only structural properties
...
class StabilityEnvelope:
    """
    Stability phase2_analysis result for the anomaly.
...
class SemanticNecessityResult:
    ...
    def generate_decision(self):
        ...
        if self.assessment == SemanticNecessity.DEFINITELY_NECESSARY:
            ...
            self.justification = (
                "Evidence is inconclusive. Additional structural phase2_analysis "
