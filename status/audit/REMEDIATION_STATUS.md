...
**Location:** `src/foundation/config.py`
...
**Location:** `src/foundation/core/randomness.py`
...
- `@requires_seed` decorator: For control/synthesis functions (enforces seed)
...
| File | Purpose |
|------|---------|
| `src/foundation/core/id_factory.py` | Deterministic ID generation |
| `src/foundation/core/randomness.py` | Randomness budget enforcement |
...
| File | Changes |
|------|---------|
| `src/foundation/core/ids.py` | Added seed parameter to RunID |
| `src/foundation/core/queries.py` | Real cosine similarity in find_similar_regions |
| `src/foundation/runs/manager.py` | Thread-safe with threading.local(), environment capture |
| `src/foundation/storage/filesystem.py` | Atomic file writes |
| `src/foundation/config.py` | REQUIRE_COMPUTED enforcement, ComputationTracker, CoverageReport |
| `src/foundation/metrics/interface.py` | calculation_method field in MetricResult |
| `src/analysis/anomaly/interface.py` | Removed all_nonsemantic_models_failed, added EXCLUSION_DECISION type |
| `src/analysis/anomaly/semantic_necessity.py` | Refactored to use measured thresholds, run real tests |
| `src/analysis/anomaly/constraint_analysis.py` | Fixed constraint type for P21_C1, P21_C2 |
| `src/analysis/models/interface.py` | Added update_status_from_predictions(), test_and_update(), test_all_predictions() |
| `src/analysis/stress_tests/locality.py` | Added iteration limits |
| `src/analysis/stress_tests/mapping_stability.py` | Added iteration limits |
| `src/analysis/stress_tests/information_preservation.py` | Added iteration limits |
...
| File | Fix |
|------|-----|
| `scripts/analysis/run_phase_2_4.py:51` | Removed reference to deleted `all_nonsemantic_models_failed` attribute |
| `scripts/analysis/run_phase_2_4.py:165-173` | Updated display function to handle new `measured_values`/`theoretical_bounds` structure |
...
REQUIRE_COMPUTED=1 python scripts/synthesis/run_phase_3.py
...
1. Created `scripts/foundation/populate_database.py`
