...
DEFAULT_SENSITIVITY_PATH = PROJECT_ROOT / "status/audit/sensitivity_sweep_release.json"
DEFAULT_SENSITIVITY_PREFLIGHT_PATH = (
    PROJECT_ROOT / "status/audit/sensitivity_release_preflight.json"
)
DEFAULT_SENSITIVITY_RUN_STATUS_PATH = (
    PROJECT_ROOT / "status/audit/sensitivity_release_run_status.json"
)
DEFAULT_CONTROL_COMPARABILITY_PATH = (
    PROJECT_ROOT / "status/synthesis/CONTROL_COMPARABILITY_STATUS.json"
)
...
DEFAULT_MULTIMODAL_STATUS_PATH = (
    PROJECT_ROOT / "results/mechanism/anchor_coupling_confirmatory.json"
)
DEFAULT_COMPARATIVE_UNCERTAINTY_PATH = (
    PROJECT_ROOT / "results/human/phase_7c_uncertainty.json"
)
DEFAULT_PROVENANCE_HEALTH_PATH = PROJECT_ROOT / "status/audit/provenance_health_status.json"
DEFAULT_PROVENANCE_SYNC_PATH = PROJECT_ROOT / "status/audit/provenance_register_sync_status.json"
