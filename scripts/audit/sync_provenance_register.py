...
DEFAULT_GATE_HEALTH_PATH = PROJECT_ROOT / "status/audit/release_gate_health_status.json"
DEFAULT_REPAIR_REPORT_PATH = PROJECT_ROOT / "status/audit/run_status_repair_report.json"
DEFAULT_DB_PATH = PROJECT_ROOT / "data/voynich.db"
DEFAULT_REGISTER_PATH = PROJECT_ROOT / "reports/skeptic/SK_M4_PROVENANCE_REGISTER.md"
DEFAULT_SYNC_STATUS_PATH = PROJECT_ROOT / "status/audit/provenance_register_sync_status.json"
