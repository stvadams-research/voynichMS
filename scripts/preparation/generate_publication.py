...
VISUALS_DIR = PROJECT_ROOT / "results/reports/visuals"
...
class PublicationGenerator:
    ...
    def load_report_content(self, filename):
    ...
    def generate(self):
        ...
        intro_technical = self.load_report_content("FINAL_REPORT_PHASE_2.md")
        self.add_chapter(
        ...
        self.add_chapter(
            ...
            [("results/reports/visuals/foundation/41f398bc-9623-2b2d-bada-5bd4dc226e64_repetition_rate_dist_voynich_real.png", "Repetition Rate Distribution across the Manuscript")]
        )
        
        # 3. MECHANISM (The Core Findings from Phase 5)
        mech_content = self.load_report_content("PHASE_5_FINAL_FINDINGS_SUMMARY.md")
        self.add_chapter(
        ...
        inf_content = self.load_report_content("PHASE_4_CONCLUSIONS.md")
        self.add_chapter(
            ...
            inf_content,
            [("results/reports/visuals/inference/821247f8-748c-cb25-1d5d-5d2877bf7f71_lang_id_comparison.png", "False Positive Rate of Language Identification Methods")]
        )
