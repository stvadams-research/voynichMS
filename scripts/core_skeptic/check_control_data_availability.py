...
TURING_ARTIFACT = "core_status/phase3_synthesis/TURING_TEST_RESULTS.json"
COMPARABILITY_ARTIFACT = "core_status/phase3_synthesis/CONTROL_COMPARABILITY_STATUS.json"
