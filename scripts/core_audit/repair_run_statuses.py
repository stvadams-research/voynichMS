...
from phase1_foundation.storage.metadata import MetadataStore, RunRecord  # noqa: E402
...
def _build_backfilled_manifest(record: RunRecord, *, fallback_status: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "backfill_source": "scripts/core_audit/repair_run_statuses.py",
    }
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report-path",
        default="core_status/core_audit/run_status_repair_report.json",
