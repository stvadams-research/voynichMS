...
def main():
    ...
    for i in range(1, len(choices)):
        ...
        num_transitions += 1
        if num_transitions > 10000: break # Sample for speed
    ...
    console.print(f"Grid Layout Efficiency: [bold green]{results['grid_efficiency']*100:.2f}% improvement over random[/bold green]")
    
    if results['grid_efficiency'] > 0.10:
        console.print("\n[bold green]VERIFIED:[/bold green] The lattice transitions are physically optimized for a 2D Grid/Grille layout.")
    else:
        console.print("\n[bold yellow]CONDITION:[/bold yellow] No strong physical optimization found for these specific geometries.")
