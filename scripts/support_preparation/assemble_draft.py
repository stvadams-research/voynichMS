...
CHAPTERS_DIR = PROJECT_ROOT / "planning/support_preparation/chapters"
...
def assemble_chapters():
    ...
    for chapter_dir in chapters:
        ...
        if not master_file.exists():
            ...
            template_path = PROJECT_ROOT / "planning/support_preparation/templates/CHAPTER_TEMPLATE.md"
        ...
        with open(master_file, "r") as f:
            content = f.read()
            # Fix relative image paths for the consolidated publication directory
            content = content.replace("../../../results/reports/visuals/", "../visuals/")
