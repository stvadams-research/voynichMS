...
Usage:
    python scripts/foundation/populate_database.py

    # With REQUIRE_COMPUTED to verify no simulation fallbacks:
    REQUIRE_COMPUTED=1 python scripts/foundation/populate_database.py
"""
...
from foundation.core.ids import PageID, FolioID
