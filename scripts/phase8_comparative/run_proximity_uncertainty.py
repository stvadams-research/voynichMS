#!/usr/bin/env python3
"""
Generate phase8_comparative distance uncertainty artifact and uncertainty-qualified proximity report.
"""
...
DEFAULT_POLICY_PATH = "configs/core_skeptic/sk_m2_comparative_uncertainty_policy.json"
PROFILE_ITERATIONS = {
    "smoke": 400,
    "standard": 2000,
    "release-depth": 8000,
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SK-M2 phase8_comparative uncertainty phase2_analysis."
    )
    parser.add_argument(
        "--iterations",
        type=int,
    ...
    parser.add_argument(
        "--target",
        default="Voynich",
        help="Target artifact label in phase8_comparative matrix.",
    )
    parser.add_argument(
        "--matrix-path",
        default="results/reports/phase8_comparative/COMPARATIVE_MATRIX.csv",
        help="Comparative matrix CSV path.",
    )
    parser.add_argument(
        "--report-path",
        default="results/reports/phase8_comparative/PROXIMITY_ANALYSIS.md",
    ...
    parser.add_argument(
        ...
        help="SK-M2 phase8_comparative uncertainty policy config path.",
    )
...
def main() -> int:
    ...
    # ProvenanceWriter in src/phase8_comparative/mapping.py.
    with active_run(
        config={
