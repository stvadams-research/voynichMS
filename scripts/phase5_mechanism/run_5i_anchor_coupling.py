...
- results/phase5_mechanism/anchor_coupling.json (legacy plain payload)
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run confirmatory anchor-coupling phase2_analysis.")
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Override phase2_analysis seed.",
    )
    parser.add_argument(
...
def run_anchor_coupling(
    *,
    ...
    inference_policy = policy.get("phase4_inference", {})
    ...
    with active_run(
        ...
        try:
            ...
            phase4_inference = evaluate_inference(
            ...
            status_payload = decide_status(adequacy=adequacy, phase4_inference=phase4_inference)
            ...
            results = {
                ...
                "adequacy": adequacy,
                "phase4_inference": phase4_inference,
