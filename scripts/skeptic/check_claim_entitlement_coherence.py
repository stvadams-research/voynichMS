...
DEFAULT_H2_POLICY_PATH = PROJECT_ROOT / "configs/skeptic/sk_h2_claim_language_policy.json"
DEFAULT_M1_POLICY_PATH = PROJECT_ROOT / "configs/skeptic/sk_m1_closure_policy.json"
...
def run_checks(
    *,
    ...
    claim_checker = _load_module(
        PROJECT_ROOT / "scripts/skeptic/check_claim_boundaries.py",
        "check_claim_boundaries",
    )
    closure_checker = _load_module(
        PROJECT_ROOT / "scripts/skeptic/check_closure_conditionality.py",
