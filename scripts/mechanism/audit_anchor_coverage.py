#!/usr/bin/env python3
"""
Audit anchored/unanchored cohort coverage before confirmatory coupling analysis.
"""
...
from mechanism.anchor_coupling import DEFAULT_MULTIMODAL_POLICY

console = Console()
DEFAULT_DB_URL = "sqlite:///data/voynich.db"
DEFAULT_POLICY_PATH = PROJECT_ROOT / "configs/skeptic/sk_h1_multimodal_policy.json"
OUTPUT_PATH = PROJECT_ROOT / "status/mechanism/anchor_coverage_audit.json"
