...
from analysis.admissibility.manager import (
    ...
    classes = [
        {
            ...
            "description": (
                "The manuscript encodes a natural human language using a novel or "
...
def step_2_define_constraints(manager: AdmissibilityManager) -> dict:
    ...
    constraints["constructed_system"] = {
        ...
        "generation_detectable": manager.add_constraint(
            "constructed_system",
            ConstraintType.OPTIONAL,
            "Generation algorithm may be detectable through statistical analysis"
        ),
...
def step_3_map_evidence(manager: AdmissibilityManager, constraints: dict):
    ...
    manager.map_evidence(
        ...
        reasoning=(
            ...
            "Word boundaries are not sufficiently objective for confident analysis."
        ),
