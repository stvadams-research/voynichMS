...
| C10 | Configuration Reference | 4 | DONE | Created docs/CONFIG_REFERENCE.md |
...
| **H10** | Missing provenance in scripts | Infrastructure | DONE | Created ProvenanceWriter and updated critical analysis/synthesis scripts. |
...
| **H13** | Missing `METHODS_REFERENCE.md` | Documentation | DONE | Created comprehensive guide for metrics and methods. |
| **H14** | Missing `REPRODUCIBILITY.md` | Documentation | DONE | Created step-by-step reproducibility guide. |
...
| **H22** | Unseeded mechanism simulators | Determinism | DONE | Added seed to all simulators in src/mechanism. |
...
| **M31** | Feature discrimination ranges | Documentation | DONE | Created docs/FEATURE_RANGES.md with expected values. |
...
| **L10** | Acknowledged arbitrary thresholds | Documentation | DONE | Created docs/CALIBRATION_NOTES.md with justifications. |
