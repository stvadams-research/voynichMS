...
Phase B demonstrates that while the Voynich Manuscript can be situated nearest to combinatorial systems, it remains **sui generis**. There is no "perfect match" in the recorded history of human formal artifacts.
