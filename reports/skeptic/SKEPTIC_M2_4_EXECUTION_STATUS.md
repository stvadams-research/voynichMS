...
- `python3 -m py_compile src/comparative/mapping.py scripts/comparative/run_proximity_uncertainty.py scripts/skeptic/check_comparative_uncertainty.py`
- `python3 -m pytest -q tests/comparative/test_mapping_uncertainty.py tests/skeptic/test_comparative_uncertainty_checker.py`
- `python3 -m pytest -q tests/audit/test_ci_check_contract.py tests/audit/test_pre_release_contract.py tests/audit/test_verify_reproduction_contract.py`
