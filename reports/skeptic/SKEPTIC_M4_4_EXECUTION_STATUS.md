...
- Added strict parity checks for lane/reason/status/orphan-count drift.
...
- `python3 -m py_compile scripts/audit/build_provenance_health_status.py scripts/audit/sync_provenance_register.py scripts/skeptic/check_provenance_uncertainty.py`
