...
Source artifact: `status/audit/provenance_health_status.json`
...
Primary sync artifact: `status/audit/provenance_register_sync_status.json`
...
Current policy source: `configs/skeptic/sk_m4_provenance_policy.json`

| Artifact | generated_utc | Policy max age | Status |
|---|---|---|---|
| `status/audit/provenance_health_status.json` | `2026-02-10T20:53:37.897691Z` | `168h` | within limit at validation time |
| `status/audit/provenance_register_sync_status.json` | `2026-02-10T20:53:37.935152Z` | `168h` | within limit at validation time |
