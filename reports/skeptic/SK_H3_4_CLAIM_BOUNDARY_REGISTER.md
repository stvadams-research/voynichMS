...
- `status/synthesis/CONTROL_COMPARABILITY_STATUS.json` -> `results.h3_4_closure_lane`
- `status/synthesis/CONTROL_COMPARABILITY_STATUS.json` -> `results.evidence_scope`
- `status/synthesis/CONTROL_COMPARABILITY_STATUS.json` -> `results.full_data_closure_eligible`
- `status/synthesis/CONTROL_COMPARABILITY_STATUS.json` -> `results.full_data_feasibility`
- `status/synthesis/CONTROL_COMPARABILITY_STATUS.json` -> `results.full_data_closure_terminal_reason`
- `status/synthesis/CONTROL_COMPARABILITY_DATA_AVAILABILITY.json` -> matching parity fields
- `status/synthesis/CONTROL_COMPARABILITY_DATA_AVAILABILITY.json` -> `results.irrecoverability.classification`
