...
- `ALLOW_DIRTY_RELEASE=1 DIRTY_RELEASE_REASON='SK-H3.5: contract parity validation' bash scripts/audit/pre_release_check.sh` -> expected fail at SK-C1 release sensitivity artifact missing.
