...
- `python3 -m pytest -q tests/mechanism/test_anchor_coupling.py tests/mechanism/test_anchor_coupling_contract.py tests/skeptic/test_multimodal_coupling_checker.py tests/human/test_phase7_claim_guardrails.py`
