...
- **Out-of-scope blocker still present globally:** SK-C1 release sensitivity artifact absence (`status/audit/sensitivity_sweep_release.json`) remains a release gate blocker, but not an H1 feasibility blocker.
