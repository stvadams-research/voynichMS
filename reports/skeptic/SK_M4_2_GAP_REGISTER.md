...
**Date:** 2026-02-10  
**Source finding:** `reports/skeptic/ADVERSARIAL_SKEPTIC_ASSESSMENT_2026-02-10_2.md` (`SK-M4`)  
...
From `status/audit/provenance_health_status.json` and runtime DB:
...
From `status/audit/provenance_register_sync_status.json`:
...
|---|---|---|---|---|---|---|
| M4.2-G1 | Skeptic register count drift vs runtime/canonical artifacts | Synchronization gap | drift present (`133` vs runtime) | `IN_SYNC` (`156` vs `156`) | RESOLVED | `scripts/audit/sync_provenance_register.py` |
