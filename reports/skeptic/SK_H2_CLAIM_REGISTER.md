...
|---|---|---|---|---|---|
| H2-C1 | `README.md` | Categorical "falsified" headline wording | `results/reports/FINAL_REPORT_PHASE_3.md`, `results/reports/PHASE_5_FINAL_FINDINGS_SUMMARY.md` | `CONCLUSIVE_WITHIN_SCOPE` | CALIBRATED |
| H2-C2 | `results/reports/PHASE_4_5_CLOSURE_STATEMENT.md` | Absolute closure phrase ("Exhaustive", "scientifically unjustified") | `results/reports/PHASE_4_RESULTS.md`, reopening criteria in same doc | `QUALIFIED` | CALIBRATED |
| H2-C3 | `results/reports/FINAL_PHASE_3_3_REPORT.md` | Semantic absolutism ("semantically empty procedural system") | `results/reports/FINAL_REPORT_PHASE_3.md`, `results/reports/PHASE_5_FINAL_FINDINGS_SUMMARY.md` | `CONCLUSIVE_WITHIN_SCOPE` | CALIBRATED |
...
- `results/reports/PHASE_5_FINAL_FINDINGS_SUMMARY.md` (explicit "What this does not claim" section)
- `results/reports/PHASE_4_5_CLOSURE_STATEMENT.md` (reopening criteria + non-claim block)
