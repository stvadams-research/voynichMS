...
2. SK-C1 release sensitivity evidence artifact remains absent (`status/audit/sensitivity_sweep_release.json`), causing release-path failures independent of SK-M2 semantics.
