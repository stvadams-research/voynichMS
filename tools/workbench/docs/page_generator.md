...
```bash
python scripts/phase18_comparative/build_page_generation_assets.py
python scripts/tools/build_workbench_bundle.py
```

### Schedule schema (v1)

Source: `results/data/phase18_comparative/folio_state_schedule.json`
...
Source: `results/data/phase18_comparative/page_priors.json`
