# VISION_AND_MASTER_ROADMAP.md
## Voynich Manuscript Project – Structural Vision and Long-Term Roadmap
...
- that glyphs are letters
- that diagrams are illustrations with labels
- that translation is the primary path to understanding

This project rejects those assumptions as a starting point.
...
All work in this project follows these principles:
...
**Purpose**  
Establish defensible structure without meaning.

**Key questions answered**
- What visual and text-like structures exist?
- What survives aggressive controls?
- What is real versus pipeline artifact?
...
### Layer 2: Analysis and Admissibility (Completed)
...
- archive_legacy prior intent rather than overwrite it
