...
| MC-2R | Medium | Historical run provenance uncertainty persists: `63` rows remain `orphaned` and all `63` lack corresponding `run.json` artifact entries. | SQLite core_audit query against `data/voynich.db`; policy framing: `governance/PROVENANCE.md:90`, `governance/PROVENANCE.md:95` |
