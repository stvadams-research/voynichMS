...
- **Primary:** `scripts/phase2_analysis/run_phase_2_*.py`, `scripts/phase3_synthesis/run_phase_3.py`
- **Secondary:** 15+ pilot scripts in `scripts/phase5_mechanism/` (exploratory)
- **Utility:** `scripts/phase1_foundation/acceptance_test.py` (database initialization)
...
- **DEBUG Prints:** `src/phase1_foundation/anchors/engine.py:77` (Production debug print).
...
- **Unseeded Simulators:** 8+ files in `src/phase5_mechanism/` use `random.Random` without global seed control.
...
| L1 | Low | Orphaned planning documents with typos | `planning/phase5_mechanism/` |
