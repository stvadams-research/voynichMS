...
| M2-C4 | `reports/phase8_comparative/PHASE_B_BOUNDARY_STATEMENT.md` | Boundary language omitted phase8_comparative uncertainty constraint | Added uncertainty-qualified interpretation reference | CALIBRATED |
...
- Allowed claim class: directional/caveated phase8_comparative claim only
