...
| H2M1-A5 | `reports/phase8_comparative/PHASE_B_SYNTHESIS.md` | Comparative closure phase3_synthesis | `ci_check`, `verify_reproduction` | Conditional closure can still be read as high-confidence finality if not operationally tagged | OPEN |
