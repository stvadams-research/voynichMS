...
- Evidence references from assessment:
  ...
  - `core_status/core_audit/provenance_health_status.json:48`
...
Primary source: `core_status/core_audit/provenance_health_status.json`
...
Sync source: `core_status/core_audit/provenance_register_sync_status.json`
...
1. Provenance drift trigger: `core_status/core_audit/provenance_register_sync_status.json` reports `drift_detected=true` or non-zero parity drift.
