...
Policy baseline: `configs/core_skeptic/sk_h1_multimodal_policy.json`
...
Stability artifacts: `/tmp/h1_2_stability/*.json` and `results/phase5_mechanism/by_run/anchor_coupling_confirmatory.<run_id>.json`
