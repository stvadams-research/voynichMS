...
Assessment source: `reports/core_skeptic/ADVERSARIAL_SKEPTIC_ASSESSMENT_2026-02-10_2.md`
...
|---|---|---|---|---|
| Pre-remediation blocked run | `results/phase5_mechanism/by_run/anchor_coupling_confirmatory.66ae6392-77e5-83ce-26fc-5964538e6623.json` | `BLOCKED_DATA_GEOMETRY` | `False` | 0 anchored/unanchored lines and pages (`geometry_or_data_block`) |
| Pre-remediation underpowered run | `results/phase5_mechanism/by_run/anchor_coupling_confirmatory.60e0aee0-5742-9386-1bc0-45fcc9311ddb.json` | `INCONCLUSIVE_UNDERPOWERED` | `False` | recurring contexts below policy minimum (`24/40 < 80`) |
...
Per-run artifacts: `results/phase5_mechanism/by_run/anchor_coupling_confirmatory.<run_id>.json`
