...
| `results/reports/FINAL_PHASE_3_3_REPORT.md` | phase5_mechanism closure summary | `check_claim_boundaries.py`, `check_closure_conditionality.py`, `check_claim_entitlement_coherence.py` | same as above | degraded, conditional closure qualified | Covered |
| `reports/phase8_comparative/PHASE_B_BOUNDARY_STATEMENT.md` | phase8_comparative closure boundary | `check_claim_boundaries.py`, `check_closure_conditionality.py`, `check_claim_entitlement_coherence.py` | same as above + degraded-state marker | degraded, contingent language required | Covered |
| `reports/phase8_comparative/PHASE_B_SYNTHESIS.md` | phase8_comparative phase3_synthesis claim | `check_claim_boundaries.py`, `check_closure_conditionality.py`, `check_claim_entitlement_coherence.py` | same as above + degraded-state marker | degraded, contingent language required | Covered |
