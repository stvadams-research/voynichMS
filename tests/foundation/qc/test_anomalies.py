...
from foundation.qc import anomalies as anomaly_module
from foundation.qc.anomalies import AnomalyLogger
...
def test_anomaly_logger_warns_when_no_active_run(monkeypatch, caplog):
    ...
    caplog.set_level(logging.WARNING, logger="foundation.qc.anomalies")
