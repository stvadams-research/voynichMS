...
- **Implementation:** `src/phase1_foundation/metrics/library.py` (RepetitionRate).
...
- **Implementation:** `src/phase2_analysis/stress_tests/information_preservation.py`.
...
- **Implementation:** `src/phase2_analysis/stress_tests/locality.py`.
...
- **Implementation:** `src/phase2_analysis/stress_tests/mapping_stability.py`.
