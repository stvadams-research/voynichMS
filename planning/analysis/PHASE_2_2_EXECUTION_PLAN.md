...
| File | Purpose |
|------|---------|
| `src/analysis/stress_tests/__init__.py` | Module init |
| `src/analysis/stress_tests/interface.py` | Base classes and result types |
| `src/analysis/stress_tests/mapping_stability.py` | Track B1 implementation |
| `src/analysis/stress_tests/information_preservation.py` | Track B2 implementation |
| `src/analysis/stress_tests/locality.py` | Track B3 implementation |
| `scripts/analysis/run_phase_2_2.py` | Execution script |
