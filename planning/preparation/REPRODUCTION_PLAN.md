...
```bash
python3 scripts/preparation/generate_publication.py
```
...
- **Phase 2 (Analysis)**: `results/reports/FINAL_REPORT_PHASE_2.md`
- **Phase 4 (Inference)**: `results/reports/PHASE_4_CONCLUSIONS.md`
- **Phase 5 (Mechanism)**: `results/reports/PHASE_5_FINAL_FINDINGS_SUMMARY.md`
- **Visuals**: Latest PNGs from `results/reports/visuals/`.

## 5. Maintenance and Customization
*   **To change the narrative**: Update the `layman` and `headline` strings within `scripts/preparation/generate_publication.py`.
...
*   **To update the Markdown Master**: Run `python3 scripts/preparation/assemble_draft.py` to get a unified `.md` version in the same output directory.
