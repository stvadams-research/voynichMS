...
- `results/data/phase4_inference/` containing run-linked tables, plots, and artifacts
- `src/phase4_inference/` code modules implementing each method with strict provenance
...
- `results/data/phase4_inference/` aggregated tables and plots derived from runs
...
- `governance/CORPUS_CONSTRUCTION.md`
...
### Code deliverables
- `src/phase4_inference/info_clustering/`
- `src/phase4_inference/network_features/`
- `src/phase4_inference/topic_models/`
- `src/phase4_inference/lang_id_transforms/`
- `src/phase4_inference/morph_induction/`
