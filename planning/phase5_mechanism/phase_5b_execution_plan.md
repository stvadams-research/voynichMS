...
Deliverable:
- `src/phase5_mechanism/generators/constraint_geometry/`
- `governance/GENERATOR_MATCHING_5B.md`
...
- `src/phase5_mechanism/constraint_geometry/`
- `phase2_analysis/phase5_mechanism/constraint_geometry/`
- `configs/phase5_mechanism/constraint_geometry/`
- `runs/phase5_mechanism/<run_id>/`
- `results/phase5_mechanism/constraint_geometry/`
- `reports/`
