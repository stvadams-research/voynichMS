...
- Seeds required and logged for phase3_synthesis/control paths.
...
- Separate:
  ...
  - support_visualization/report generation
...
- Move deprecated code to `archive_legacy/` with a clear label, or delete it.
