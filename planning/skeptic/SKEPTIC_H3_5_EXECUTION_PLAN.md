...
|---|---|---|---|
| A1 | Freeze pass-5 SK-H3 tuple from both canonical artifacts. | New `reports/skeptic/SK_H3_5_BASELINE_REGISTER.md` | Single source of truth with run-id/timestamp metadata. |
...
| B2 | Add explicit terminal-qualified residual reason and reopen-trigger contract. | status/checker outputs | Reopen loop cannot occur without objective trigger. |
...
| ID | Task | Target Artifacts | Completion Signal |
|---|---|---|---|
| D1 | Build SK-H3.5 claim-boundary register (allowed/disallowed language by lane). | New `reports/skeptic/SK_H3_5_CLAIM_BOUNDARY_REGISTER.md` | Claim scope is explicit and auditable. |
| D2 | Synchronize docs/reports to lane-qualified language where SK-H3 appears. | docs + reports | No full-data comparability claims when lane is terminal-qualified. |
...
| ID | Task | Target Artifacts | Completion Signal |
|---|---|---|---|
| E1 | Add SK-H3 terminal-qualified criterion to playbook irrecoverable section. | `planning/skeptic/ADVERSARIAL_SKEPTIC_PLAYBOOK.md` | Playbook explicitly distinguishes non-fixable data blockers from fixable process defects. |
...
```bash
rg -n "irrecoverable|approved-lost|terminal|reopen|new primary" planning/skeptic/ADVERSARIAL_SKEPTIC_PLAYBOOK.md
```
...
| ID | Task | Target Artifacts | Completion Signal |
|---|---|---|---|
| F1 | Add SK-H3.5 tests for lane mapping and terminal-qualified invariants. | skeptic/audit tests | H3.5 semantics are regression-locked. |
| F2 | Add SK-H3.5 decision record and blocker ledger (fixable vs non-fixable). | New `reports/skeptic/SK_H3_5_DECISION_RECORD.md` | Blockers are explicit and non-ambiguous. |
| F3 | Add SK-H3.5 execution status report with command evidence and outcomes. | New `reports/skeptic/SKEPTIC_H3_5_EXECUTION_STATUS.md` | Fifth-pass traceability is complete. |
...
1. `reports/skeptic/SK_H3_5_BASELINE_REGISTER.md`
2. `reports/skeptic/SK_H3_5_CLAIM_BOUNDARY_REGISTER.md`
3. `reports/skeptic/SK_H3_5_DECISION_RECORD.md`
4. `reports/skeptic/SKEPTIC_H3_5_EXECUTION_STATUS.md`
