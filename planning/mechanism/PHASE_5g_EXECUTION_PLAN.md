...
Deliverables:
- `src/mechanism/topology_collapse/`
- `docs/TOPOLOGY_SIMULATOR_SPEC.md`
...
- `src/mechanism/topology_collapse/`
- `analysis/mechanism/topology_collapse/`
- `configs/mechanism/topology_collapse/`
- `runs/mechanism/<run_id>/`
- `results/mechanism/topology_collapse/`
- `reports/`
