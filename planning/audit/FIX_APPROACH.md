...
Keep them, do not delete, but move them to an /archive/simulated_findings/ folder with a README explaining the audit.
...
│                                                                                                │
│ File: src/foundation/metrics/library.py                                                        │
│                                                                                                │
...
│                                                                                                │
│ 2.1 src/foundation/hypotheses/library.py                                                       │
│                                                                                                │
...
│                                                                                                │
│ 2.2 src/foundation/hypotheses/destructive.py                                                   │
...
│                                                                                                │
│ 3.1 src/analysis/stress_tests/locality.py                                                      │
│ ┌──────────────────────────────┬───────────┬───────────────────────────────────────────┐       │
...
│ └──────────────────────────────┴───────────┴───────────────────────────────────────────┘       │
│ 3.2 src/analysis/stress_tests/mapping_stability.py                                             │
│ ┌──────────────────────────────┬───────────┬────────────────────────────────────────────┐      │
│ │            Method            │ Hardcoded │              Real Computation              │      │
│ ├──────────────────────────────┼───────────┼────────────────────────────────────────────┤      │
...
│ └──────────────────────────────┴───────────┴────────────────────────────────────────────┘      │
│ 3.3 src/analysis/stress_tests/information_preservation.py                                      │
│                                                                                                │
...
│                                                                                                │
│ 4.1 src/analysis/models/visual_grammar.py                                                      │
│                                                                                                │
│ apply_perturbation()                                                                           │
...
│                                                                                                │
│ 4.2 src/analysis/models/constructed_system.py                                                  │
│                                                                                                │
...
│                                                                                                │
│ 5.1 src/synthesis/profile_extractor.py                                                         │
│                                                                                                │
...
│                                                                                                │
│ 5.2 src/synthesis/refinement/feature_discovery.py                                              │
│                                                                                                │
...
│ ────────────────────────────────────────                                                       │
│ Priority: 2                                                                                    │
│ File: src/foundation/hypotheses/library.py                                                     │
│ Changes: 1 method                                                                              │
│ ────────────────────────────────────────                                                       │
│ Priority: 3                                                                                    │
│ File: src/foundation/hypotheses/destructive.py                                                 │
│ Changes: 4 hypothesis classes                                                                  │
│ ────────────────────────────────────────                                                       │
│ Priority: 4                                                                                    │
│ File: src/analysis/stress_tests/information_preservation.py                                    │
│ Changes: 1 method (string matching)                                                            │
│ ────────────────────────────────────────                                                       │
│ Priority: 5                                                                                    │
│ File: src/analysis/stress_tests/locality.py                                                    │
│ Changes: 6 methods                                                                             │
│ ────────────────────────────────────────                                                       │
│ Priority: 6                                                                                    │
│ File: src/analysis/stress_tests/mapping_stability.py                                           │
│ Changes: 4 methods                                                                             │
│ ────────────────────────────────────────                                                       │
│ Priority: 7                                                                                    │
│ File: src/analysis/models/visual_grammar.py                                                    │
│ Changes: 3 apply_perturbation methods                                                          │
│ ────────────────────────────────────────                                                       │
│ Priority: 8                                                                                    │
│ File: src/analysis/models/constructed_system.py                                                │
│ Changes: 3 apply_perturbation methods                                                          │
│ ────────────────────────────────────────                                                       │
│ Priority: 9                                                                                    │
│ File: src/synthesis/profile_extractor.py                                                       │
│ Changes: Remove SIMULATED_PAGE_DATA                                                            │
│ ────────────────────────────────────────                                                       │
│ Priority: 10                                                                                   │
│ File: src/synthesis/refinement/feature_discovery.py                                            │
│ Changes: compute_feature registry                                                              │
│ ---                                                                                            │
│ Reusable Patterns                                                                              │
│                                                                                                │
│ Follow these existing real implementations:                                                    │
│ - src/foundation/core/geometry.py - IoU, distance, containment (tested, proven)                │
│ - src/synthesis/indistinguishability.py - Vector distance, centroid, separation scoring        │
│ - src/foundation/controls/scramblers.py - Database manipulation with seed control              │
│ - src/foundation/analysis/stability.py - Anchor degradation calculation                        │
│ - src/foundation/core/queries.py - QueryEngine patterns for DB access                          │
│                                                                                                │
│ ---                                                                                            │
