...
Deliverables:
- `src/mechanism/deterministic_grammar/`
- `docs/DETERMINISTIC_SIMULATOR_SPEC.md`
...
- `src/mechanism/deterministic_grammar/`
- `analysis/mechanism/deterministic_grammar/`
- `configs/mechanism/deterministic_grammar/`
- `runs/mechanism/<run_id>/`
- `results/mechanism/deterministic_grammar/`
- `reports/`
