...
Deliverables:
- `src/mechanism/entry_selection/`
- `docs/ENTRY_SIMULATOR_SPEC.md`
...
- `src/mechanism/entry_selection/`
- `analysis/mechanism/entry_selection/`
- `configs/mechanism/entry_selection/`
- `runs/mechanism/<run_id>/`
- `results/mechanism/entry_selection/`
- `reports/`
