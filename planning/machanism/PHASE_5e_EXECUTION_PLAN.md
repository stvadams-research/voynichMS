...
Deliverables:
- `src/mechanism/large_object/`
- `docs/LARGE_OBJECT_SIMULATOR_SPEC.md`
...
- `src/mechanism/large_object/`
- `analysis/mechanism/large_object/`
- `configs/mechanism/large_object/`
- `runs/mechanism/<run_id>/`
- `results/mechanism/large_object/`
- `reports/`
