...
### Code
- `src/phase6_functional/phase_6c/learnability_tests.py`
- `src/phase6_functional/phase_6c/adversarial_metrics.py`

### Data
- `results/phase6_functional/phase_6c/phase_6c_results.json`
