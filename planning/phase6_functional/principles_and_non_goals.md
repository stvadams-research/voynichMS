...
## Phase 6 — Functional Differentiation Under a Frozen Mechanism

**Project:** Voynich Manuscript, Structural Admissibility Program  
**Phase:** 6  
**Status:** Pre-registered framing document  
**Purpose:** Explicitly define what Phase 6 is allowed to do, what it is not allowed to do, and the principles that govern all subsequent Phase 6 work.

---

## 1. Phase 6 Position in the Program

Phase 6 begins **after** internal structural identifiability has been completed (Phases 1–5K).
...
Phase 6 investigates *function*, not *meaning*.
...
Phase 6 assumes *how* the manuscript was generated is known.

---

### 3.2 Testability Requirement
Every Phase 6 hypothesis must make **distinct, falsifiable, structural predictions**.

Disallowed:
- narratives that cannot be falsified,
- claims about intent without observable consequences,
- explanations that “fit anything”.

Allowed:
- predictions about coverage, redundancy, error structure,
- optimization vs inefficiency signatures,
- adversarial sensitivity,
- usage vs exhaustion patterns.

---

### 3.3 Non-Semantic Discipline
Phase 6 does **not** assume or search for meaning.

Specifically prohibited:
- translation attempts,
- semantic glosses,
- symbolic interpretation of glyphs or diagrams,
- claims that meaning exists “but is hidden”.

If meaning is invoked, it must be:
- external to the text, and
- explicitly labeled as a new assumption (outside Phase 6 scope).
...
- What constraints does its structure optimize for?

Phase 6 does **not** ask:
- What did the author believe?
- What did the author intend to communicate?
- What cultural symbolism motivated it?
...
- determine what the manuscript “says”,
- identify a language, cipher, or code,
- infer the author’s beliefs, intentions, or identity,
- reconstruct historical usage without external evidence,
- explain illustrations symbolically,
- assert religious, mystical, or cultural significance.

Any work pursuing those goals is outside Phase 6 and must be labeled as a separate project.

---

## 6. Evidence Scope

### 6.1 Permitted Evidence
- Text-internal structure (new analyses allowed)
- Error patterns and deviations
- Coverage and redundancy metrics
- Distributional inefficiencies
- Sensitivity to perturbation
- Layout-independent structural effects

### 6.2 Restricted Evidence
- Codicological or historical data may be referenced **only** if:
  - treated as external constraints, and
  - not used to infer meaning.
...
**Next:** Define Phase 6A execution plan (Formal-System Exhaustion)
