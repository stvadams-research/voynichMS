...
2. Direct linkage to `docs/REOPENING_CRITERIA.md`.
...
- CI: `python3 scripts/skeptic/check_closure_conditionality.py --mode ci`
- Pre-release: `python3 scripts/skeptic/check_closure_conditionality.py --mode release`
